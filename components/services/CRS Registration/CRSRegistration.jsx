...
const intro = (
  <div className="flex flex-col gap-5">
    <SectionHeadingTwo as="h1">BIS CRS Registration</SectionHeadingTwo>

    <ServiceImage
      src="/images/services/CRS/CRSRegistration.webp"
    ...
    <ServiceParagraph>
      BIS Registration is a quality certification granted by the Bureau of Indian
      Standards (BIS), the national standards body of India. It serves as an
      assurance that a product complies with the applicable Indian Standards
      relating to quality, safety, and performance before it is introduced into
      the Indian market.
    </ServiceParagraph>

    <ServiceParagraph>
      The Bureau of Indian Standards (BIS) is the national standardization body in
      India and works under the Ministry of Consumer Affairs, Food and Public
...
const EligibilitySection = () => (
  <div className="flex flex-col gap-5">
    ...
    <SectionHeadingThree>Eligibility Criteria Checklist</SectionHeadingThree>
    ...
    <ServiceParagraph>
      ...
      Authorized Indian Representative (AIR) for communication and representation
      in India.
    </ServiceParagraph>

    <SectionHeadingThree>Responsibilities of the AIR:</SectionHeadingThree>
    ...
    <SectionHeadingThree>Real life Scenario:</SectionHeadingThree>
  ...
  <div className="flex flex-col gap-5">
    ...
    <ServiceTable
      ...
      rows={[
        ...
        ["Fee Receipt", "Applicant", "Payment proof of government fee"],
        [
...
const RegistrationSection = () => (
  <div className="flex flex-col gap-5">
    ...
    <SectionHeadingThree>Step 2: Document Preparation</SectionHeadingThree>
    ...
    <SectionHeadingThree>Step 3: Filling the Online Application</SectionHeadingThree>

    <ServiceParagraph>
      Go to the BIS CRS Portal (
      <Link
    ...
    <SectionHeadingThree>Step 4: BIS&apos;s Review of the Application</SectionHeadingThree>
    ...
    <SectionHeadingThree>Step 5: Grant of BIS Registration</SectionHeadingThree>

    <ServiceParagraph>
      BIS Certificate will be issued if BIS officials are satisfied with the
      results of the assessments they conducted. Your certificate will include:
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      Your product label must contain or have e-labelling of the certificate&apos;s
      details.
    </ServiceParagraph>

    <SectionHeadingThree>Step 6: Labeling and Distribution</SectionHeadingThree>

    <ServiceParagraph>BIS certified products must carry:</ServiceParagraph>
    ...
    <ServiceParagraph>
      The registration number and BIS logo must be printed or digitally embedded
...
const ELabellingSection = () => (
  <div className="flex flex-col gap-5">
    ...
    <ServiceParagraph>
      The entire BIS CRS registration is very technical and exhaustive with regard
      to rules and the volume of documentation. In the absence of a thorough
      understanding of the Indian Standards, recent QCOs, the structure of the
      test report, and the workflows in the portal interface, applicants stand to
      lose substantially in terms of the subsequent actions of delays, rejection,
      or long-standing active non-compliance. This is where Sun Certifications
      India comes in with a reputable and reliable associate to assist the
      applicant in every detail of the compulsory certification scheme.
    </ServiceParagraph>
  </div>
);
...
const sections = [
  ...
  },
  {
    ...
    section: <RegistrationFeesSection />,
  },
  {
    id: "e-labelling",
    label: "E-Labelling",
    section: <ELabellingSection />,
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "BIS CRS: For electronics and IT goods, only for mandatory products notified under QCO. ISI mark: Used for a broader range of products, may be voluntary or mandatory depending on the product category.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Testing Charges: ₹10,000–₹20,000 + GST. Government Fee: ₹53,000 + GST per test report. Additional Charges: Affidavit, courier, AIR documentation, etc. Discount applicable for Indian MSME registered manufacturers.",
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        and navigate to the &quot;Products under CRS&quot; section.
      </>
    ),
  },
  {
    ...
    answer:
      "Yes, through e-labelling, but it must meet strict BIS rules: Label info must be embedded in firmware; easy access within 4 steps in device menu; physical packaging must still carry regulatory info.",
  },
  {
    question:
      "What happens if I don't get BIS registration for a mandatory product?",
    answer:
      "Severe penalties, including: Product seizure, Customs rejections, Legal fines, Delisting from e-commerce portals, Permanent ban from Indian market.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We offer: Full documentation support, Lab coordination, BIS portal application handling, Query resolution and BIS follow-ups, Renewal and labeling guidance, Compliance assurance for foreign brands via AIR services.",
  },
];
