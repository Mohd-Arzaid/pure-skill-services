...
const ServiceLanguageSelector = ({ languages }) => {
  ...
  return (
    <div className="max-w-[88rem] mx-auto px-4 py-8 md:p-8">
      <div className="flex flex-col items-center gap-6">
        {/* Heading */}
        <div className="flex flex-col items-center">
          <p className="font-inter text-base md:text-lg text-center text-neutral-700">
        ...
        <div className="w-full max-w-[1400px]">
          <div className="flex flex-wrap justify-center items-center gap-2.5 md:gap-4">
                ...
                >
                  ...
                  >
                    <img
                      ...
                      className="w-full h-full object-cover rounded-sm border border-neutral-300"
                    />
                  </div>
                  {/* Active Indicator */}
                  {isActive && (
                    <div className="absolute -top-1 -right-1 w-3 h-3 bg-teal-700 rounded-full border-2 border-white"></div>
                  )}
                </Link>
              );
            })}
